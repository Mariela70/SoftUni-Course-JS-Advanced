...
describe("Book Selection", () => {
  describe("isGenreSuitable", () => {
    ...
    it('inappropriate genre for the age', () => {
      ...
      expect(bookSelection.isGenreSuitable('Horror', 10)).to.equal('Books with Thriller genre are not suitable for kids at 10 age')
    });
    it('inappropriate genre for the age second case', () => {
      expect(bookSelection.isGenreSuitable('Thriller', 12)).to.equal('Books with Thriller genre are not suitable for kids at 12 age');
      expect(bookSelection.isGenreSuitable('Horror', 12)).to.equal('Books with Thriller genre are not suitable for kids at 12 age')
    });
  });
});
